"""
Django settings for lna project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (lna/config/settings/base.py - 3 = lna/)
APPS_DIR = ROOT_DIR.path('lna')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'lna.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'lna.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'lna.users.adapters.SocialAccountAdapter'
